...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDESITE("endesite", 42, new int[] { 10, 15, 12, 10 }, 20, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 6f, 0f, () -> Ingredient.ofItems(ModItems.ENDESITE_INGOT))
    ;
    ...
    private static final int[] BASE_DURABILITY = { 15, 20, 16, 17};
    ...
    public String getName() {
        return BossesAndMore.MOD_ID + ":" + this.name;
    }
